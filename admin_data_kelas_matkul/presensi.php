                  ...
                  <div class="col-md-3 border-right"> 
                    <div class="box-profile text-center"> 
                      ...
                      <?php
                        ...
                        ?>
                        <a href="pertemuan.php?id=<?= $kode_kelas ?>;" class="btn btn-secondary btn-block mt-3">
                  ...
                  <div class="col-md-3"> 
                    <div class="text-center"> 
                      ...
                      <div class="alert alert-warning p-2 mt-2">
                        ...
                        <h4 id="demo" class="font-weight-bold text-danger m-0">01:00</h4>
                      </div>
                      <?php 
                      } else {
                        ?>
          ...
          <div class="col-md-12"> 
            <div class="card card-primary"> 
              ...
              <div class="card-body table-responsive"> 
                 <?php include 'tabel_kehadiran.php' ?>
              </div> 
            </div> 
          </div> 
        </div> 
...
<script>
  function refresh_tabel(){
      $('#presensi').load('tabel_kehadiran.php?id=<?= $kode_kelas?> & id_pertemuan=<?= $id_pertemuan ?>')
      seTimeout(refresh_tabel, 2000);
  };
  refresh_tabel();
</script>
